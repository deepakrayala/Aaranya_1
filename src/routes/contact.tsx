  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contact Aranya" },
      {
        ...
        content: "Herbalists, hours and the door of the apothecary.",
      },
    ],
  }),
...
const channels = [
  {
    icon: Mail,
    label: "Write",
    value: "hello@aranya.earth",
    sub: "Reply within 24 hours",
  },
  {
    icon: Phone,
    label: "Call",
    value: "+91 80 4000 8200",
    sub: "Mon–Sat · 10:00 to 19:00 IST",
  },
  {
    icon: MapPin,
    label: "Visit",
    value: "12 Lavelle Road, Bengaluru 560 001",
    sub: "By appointment, Tue–Sun",
  },
  {
    icon: Instagram,
    label: "Follow",
    value: "@aranya.earth",
    sub: "Field notes & rituals",
  },
];
    ...
    <div className="relative bg-umber text-cream">
      ...
      <PageHero
        ...
        title={
          <>
            The door is open.{" "}
            <em className="not-italic italic text-terra">
              Walk in, write in.
            </em>
          </>
        }
        ...
        <div className="mx-auto grid max-w-6xl gap-16 lg:grid-cols-[1.2fr_1fr]">
          <Reveal>
            ...
            >
              ...
              <div>
                <label className="text-[10px] uppercase tracking-[0.32em] text-sand/70">
                  Subject
                </label>
              ...
              <div>
                <label
                  htmlFor="message"
                  className="text-[10px] uppercase tracking-[0.32em] text-sand/70"
                >
                  Your letter
                </label>
              ...
              <motion.button
                ...
                type="submit"
                disabled={sending}
                className="group inline-flex items-center gap-3 rounded-full bg-cream px-6 py-3 text-[12px] uppercase tracking-[0.25em] text-umber transition hover:bg-sand disabled:cursor-not-allowed disabled:opacity-60"
              >
                {sent
                  ? "Letter received"
                  : sending
              ...
              {error && (
                <motion.p
                  initial={{ opacity: 0, y: 6 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="text-[12px] uppercase tracking-[0.22em] text-red-300"
                >
                  {error}
                </motion.p>
              )}
            ...
            <div className="sticky top-28 space-y-6">
              <div className="overflow-hidden rounded-sm border border-cream/10 bg-walnut/40">
                <div className="relative aspect-[4/3] overflow-hidden bg-umber">
                  ...
                  <div className="absolute bottom-5 left-5 right-5">
                    <span className="text-[10px] uppercase tracking-[0.32em] text-sand/80">
                      Flagship apothecary
                    </span>
                ...
                <div className="space-y-4 p-6">
                  {[
                    ...
                    <div
                      key={row.d}
                      className="flex items-baseline justify-between border-b border-cream/8 pb-3 last:border-0 last:pb-0"
                    >
                      <span className="text-[12px] uppercase tracking-[0.22em] text-cream/65">
                        {row.d}
                      </span>
              ...
              <div className="rounded-sm border border-sand/20 bg-walnut/30 p-6">
                ...
                <p className="mt-3 text-[14px] leading-relaxed text-cream/75">
                  Book a 45-minute private session with a senior herbalist —
                  pulse reading, dosha mapping and a custom 28-day protocol. ₹
                  2,400, redeemable against your first kit.
                </p>
              </div>
            </div>
          </Reveal>
